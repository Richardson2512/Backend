...
const PLAN_IDS = {
  standard: process.env.DODO_STANDARD_PLAN_ID || 'pdt_vB1m50QapOBhuHMN9HSqr', // InsightSnap Standard
  pro: process.env.DODO_PRO_PLAN_ID || 'pdt_yAgzJnUO12DbiNRhgGkay' // InsightSnap Pro
};
